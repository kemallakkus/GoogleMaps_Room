...
import com.kemalakkus.kotlinmaps.adepter.PlaceAdepter
import com.kemalakkus.kotlinmaps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleResponse(placeListe:List<Place>) {
        binding.recyclerView.layoutManager = LinearLayoutManager(this)
        val adapter = PlaceAdepter(placeListe)
